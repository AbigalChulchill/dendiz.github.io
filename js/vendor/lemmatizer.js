...
var Lemmatizer = function() {
  this.wn_files = {
    noun: [
      '/js/vendor/dict/index.noun.json',
      '/js/vendor/dict/noun.exc.json'
    ],
    verb: [
      '/js/vendor/dict/index.verb.json',
      '/js/vendor/dict/verb.exc.json'
    ],
    adj:  [
      '/js/vendor/dict/index.adj.json',
      '/js/vendor/dict/adj.exc.json'
    ],
    adv:  [
      '/js/vendor/dict/index.adv.json',
      '/js/vendor/dict/adv.exc.json'
    ]
  };
